...
public class WebDriverFactory {
  ...
  public static WebDriver getDriver(String hub, Capabilities capabilities) throws MalformedURLException {
    count++;
  ...
  public static WebDriver getDriver(Capabilities capabilities) throws MalformedURLException {
  ...
  private static WebDriver newWebDriver(String hub, Capabilities capabilities) throws MalformedURLException {
    driver = (hub == null)
  ...
  private static WebDriver createRemoteDriver(String hub,
    ...
    try {
      if (browserType.equals("sauce")) {
          DesiredCapabilities cpb = (DesiredCapabilities) capabilities;
          cpb.setBrowserName("firefox");
          return new RemoteWebDriver(
                  new URL("http://ko4evnik_github:b676b9af-6cb6-4bd4-8e90-24e80e5badbb@ondemand.saucelabs.com:80/wd/hub"),
                  cpb);}
  ...
  private static WebDriver createLocalDriver(Capabilities capabilities) throws MalformedURLException {
    String browserType = capabilities.getBrowserName();
    ...
    if (browserType.equals("sauce")){
      DesiredCapabilities cpb = (DesiredCapabilities) capabilities;
      cpb.setBrowserName("firefox");
      return createRemoteDriver("http://ko4evnik_github:b676b9af-6cb6-4bd4-8e90-24e80e5badbb@ondemand.saucelabs.com:80/wd/hub",
              cpb);}
